...
if (document.getElementById("game-chishenme-index")) {
  $(function () {
    axios__WEBPACK_IMPORTED_MODULE_0___default().post("/games/chishenme/list", {
      _token: csrf_token
    }).then(function (r) {
      var data = r.data;
      ...
      if (data.success === false) {
        ...
        $("#chishenme-start").click(function () {
          var list = data.result; //console.log(list)
  ...
  var app = {
    ...
    methods: {
      submit: function submit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post("/games/chishenme/addFood", {
          _token: csrf_token,
          name: this.name
        }).then(function (r) {
          var data = r.data;
